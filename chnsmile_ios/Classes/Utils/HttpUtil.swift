...
class HttpUtil {
    ...
    static func jsonRequestUrlParamters(_ parameters: [String: Any], _ urlParameters: [String: Any]) -> Task {
        return .requestCompositeParameters(bodyParameters: parameters,
                                           bodyEncoding: JSONEncoding.default,
                                           urlParameters: urlParameters)
    }
    
    static func getRequestParamters(_ parameters: [String: Any]) -> Task {
